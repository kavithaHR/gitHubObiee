...
public class partyNm_MGS_Test extends driverSelection{
	public static Logger log=LogManager.getLogger(partyNm_MGS_Test.class.getName());	
	@Test
	...
	prt.lgn().click();
	d.until(ExpectedConditions.visibilityOfAllElements(prt.Iddselection_MGS()));
	Assert.assertEquals(prt.iddselection_MGS().getText(), "FA MGS IDD App");
	log.info("successfully logged in");
	System.out.println("loginpass");
	String idds2=prt.iddselection_MGS().getText();
	System.out.println(idds2);
	prt.iddselection_MGS().click();
	Thread.sleep(10000);
