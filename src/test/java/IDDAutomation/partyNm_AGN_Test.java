...
public class partyNm_AGN_Test extends driverSelection{
	public static Logger log=LogManager.getLogger(partyNm_AGN_Test.class.getName());	
	@Test
	public void AGN_Val() throws IOException, InterruptedException
	{
	...
	prt.lgn().click();
	d.until(ExpectedConditions.visibilityOfAllElements(prt.Iddselection_AGN()));
	Assert.assertEquals(prt.iddselection_AGN().getText(), "FA AGN IDD App");
	log.info("successfully logged in");
	System.out.println("loginpass");
	String idds2=prt.iddselection_AGN().getText();
	System.out.println(idds2);
	prt.iddselection_AGN().click();
	Thread.sleep(10000);
...
//	//queries
	...
	Thread.sleep(10000);
	prt.personSearchData().sendKeys("John");
	Thread.sleep(10000);
	...
	log.info("successfully clicked on xref button");
	System.out.println("historypass _Person");
