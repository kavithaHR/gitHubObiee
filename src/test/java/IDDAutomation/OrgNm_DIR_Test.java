...
public class OrgNm_DIR_Test extends driverSelection{
		public static Logger log=LogManager.getLogger(OrgNm_DIR_Test.class.getName());	
		@Test
		...
		String idds1=org.Iddselection_Org_DIR().getText();
		System.out.println(idds1);
		
		////IDD selection
		
		org.Iddselection_Org_DIR().click();
		Thread.sleep(10000);
