...
public class partyNm_Party_Test extends driverSelection{
	public static Logger log=LogManager.getLogger(partyNm_Party_Test.class.getName());	
	@Test
	...
	prt.lgn().click();
	d.until(ExpectedConditions.visibilityOfAllElements(prt.Iddselection_Party()));
	Assert.assertEquals(prt.iddselection_PARTY().getText(), "FA PARTY IDD App");
	log.info("successfully logged in");
	System.out.println("loginpass");
	String idds2=prt.iddselection_PARTY().getText();
	System.out.println(idds2);
	prt.iddselection_PARTY().click();
	Thread.sleep(10000);
