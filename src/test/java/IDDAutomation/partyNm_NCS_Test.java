...
public class partyNm_NCS_Test extends driverSelection{
	public static Logger log=LogManager.getLogger(partyNm_NCS_Test.class.getName());	
	@Test
	public void NCS_Val() throws IOException, InterruptedException
	{
	...
	prt.lgn().click();
	d.until(ExpectedConditions.visibilityOfAllElements(prt.Iddselection_NCS()));
	Assert.assertEquals(prt.iddselection_NCS().getText(), "FA NCS IDD App");
	log.info("successfully logged in");
	System.out.println("loginpass");
	String idds2=prt.iddselection_NCS().getText();
	System.out.println(idds2);
	prt.iddselection_NCS().click();
	Thread.sleep(10000);
