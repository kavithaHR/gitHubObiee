...
public class OrgNm_AGN_Test extends driverSelection{
	public static Logger log=LogManager.getLogger(OrgNm_AGN_Test.class.getName());	
	@Test
	...
	org.lgn().click();
	d.until(ExpectedConditions.visibilityOfAllElements(org.Iddselection_Org_AGN()));
	Assert.assertEquals(org.Iddselection_Org_AGN().getText(), "FA AGN IDD App");
	log.info("successfully logged in");
	System.out.println("loginpass");
	String idds1=org.Iddselection_Org_AGN().getText();
	System.out.println(idds1);
	
	////IDD selection
	
	org.Iddselection_Org_AGN().click();
	Thread.sleep(10000);
