...
public class OrgNm_NCS_Test extends driverSelection{
	public static Logger log=LogManager.getLogger(OrgNm_NCS_Test.class.getName());	
	@Test
	...
	org.lgn().click();
	d.until(ExpectedConditions.visibilityOfAllElements(org.Iddselection_Org_NCS()));
	Assert.assertEquals(org.Iddselection_Org_NCS().getText(), "FA NCS IDD App");
	log.info("successfully logged in");
	System.out.println("loginpass");
	String idds1=org.Iddselection_Org_NCS().getText();
	System.out.println(idds1);
	
	////IDD selection
	
	org.Iddselection_Org_NCS().click();
	Thread.sleep(10000);
